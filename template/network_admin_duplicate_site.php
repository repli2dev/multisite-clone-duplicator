    ...
    <form method="post" action="<?php echo network_admin_url('sites.php?page=' . MUCD_SLUG_NETWORK_ACTION . '&action=' . MUCD_SLUG_ACTION_DUPLICATE); ?>">
        ...
        <table class="form-table" id="advanced-options" style="display: none;">
            ...
            <tr>
                ...
                <td>
                    <label><input <?php checked( get_site_option( 'mucd_truncate_content', 'no' ), 'yes' ); ?> name="site[truncate_content]" type="checkbox" value="yes" /><?php echo MUCD_NETWORK_PAGE_DUPLICATE_CONTENT_TEXT_1; ?></label><br>
                </td>
            </tr>
